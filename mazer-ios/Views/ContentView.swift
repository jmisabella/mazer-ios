...
struct ContentView: View {
    ...
    private func submitMazeRequest() {
        ...
        DispatchQueue.global().async {
            ...
            let maxHeightRows = max(1, Int(availableH / (selectedMazeType == .octoSquare ? octagonCellSize : squareCellSize)))
            ...
            let maxWidth = max(1, Int(UIScreen.main.bounds.width / (selectedMazeType == .octoSquare ? octagonCellSize : squareCellSize)))
